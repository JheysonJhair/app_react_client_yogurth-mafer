  ...
  return (
    <div className="max-w-sm rounded-lg overflow-hidden shadow-lg my-4 bg-white dark:bg-gray-800 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
      ...
      <div className="px-6 py-4">
        <div className="font-bold text-xl mb-2 text-primary-dark dark:text-white">
          {name}
        </div>
  ...
  const [markets] = useState([
    {
      id: 1,
      name: "Santa Cecilia",
      location: "Parque Micaela",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNrnCNvQHEbspBcPhBGRZYqdOxZgoIKYh5Qg&s",
    },
    {
      id: 2,
      name: "Super Mas",
    ...
    {
      id: 3,
      name: "Almacenes Salazar",
      location: "Av. Nuñez",
      image:
        "https://perureports.com/wp-content/uploads/2017/04/tambo-lima-peru.png",
    },
    {
      id: 4,
      name: "Caserita",
      location: "Jr. Apurimac",
      image:
        "https://www.americaeconomia.com/sites/default/files/styles/1280x720/public/2024-03/000506340W.jpg?itok=gdP7zFNB",
    },

    {
      ...
      location: "Tamburco",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzEKywivBS6tTFYg-JGuEll-qvmjYbaSEhfA&s",
    },
    {
      id: 6,
      name: "Caserita",
      ...
      image:
        "https://lh5.googleusercontent.com/p/AF1QipPTB6uIAsP4HxNz6at9O4IuTbWta_gJIibn49DP=w650-h486-k-no",
    },
    {
      id: 7,
      name: "Gotiyo Market",
    ...
    {
      id: 8,
      name: "Almacenes Santa Cecilia",
      location: "Jr. Cusco",
      image:
        "https://jpsystems.pe/wp-content/uploads/2021/07/Requisitos-para-iniciar-un-negocio-de-Minimarket-en-Peru.jpg",
    },
    {
      id: 9,
      name: "Copiadora Cielito",
      location: "Av. Peru",
      image:
        "https://img.freepik.com/vector-premium/ilustracion-vector-fachada-tienda-abarrotes-escaparate-edificio-tienda-vista-frontal-fachada-tienda-dibujos-animados-plana-eps-10_505557-737.jpg",
    },
  ]);
  ...
  return (
    <>
      ...
      <section className="text-justify max-w-7xl mx-auto mt-12 py-0 px-5">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-10 my-14">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-black">
              ...
              yogurths a nivel local y nacional, destacándonos por la calidad,
              innovación y compromiso con la salud y el bienestar de nuestros
              consumidores."
            </p>
          </div>
        </div>
        ...
        <p className="text-black">
          "Descubre los minimarkets en Abancay donde puedes encontrar una amplia
          variedad de nuestros productos. Cada mercado se destaca por ofrecer un
          excelente servicio al cliente y un ambiente agradable, haciendo de tus
          compras diarias una experiencia satisfactoria. ¡Explora nuestras
          opciones y encuentra el mercado más cercano a ti!"
        </p>
